...
<Link to={""} className='text-decoration-none' ><p className='fw-light text-dark' >Terms of Use</p></Link>     
        ...
        <div className='d-flex justify-content-between px-5'>
          <p className='fw-light' >English(UK)</p>
             <p className='fw-light' >©2025 hyred.All Right Reseved</p>
          <p className='' ><FontAwesomeIcon className='fs-3 text-dark' icon={faSquareLinkedin} />
          <FontAwesomeIcon className='fs-3 text-dark' icon={faXTwitter} />
                    <FontAwesomeIcon className='fs-3 text-dark' icon={faInstagram} />
          <FontAwesomeIcon className='fs-3 text-dark' icon={faGithub} />
